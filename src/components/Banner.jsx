  ...
  return (
    <>
      <div className="relative w-full max-w-5xl ml-auto mr-auto mt-0 mb-3 xl:w-[95vw] rounded-lg">
        ...
        <div className="absolute top-12 left-6 w-full border border-black flex flex-col items-start md:items-center md:justify-center md:left-0 md:top-14">
          <h1 className="text-3xl font-bold text-slate-900 filter drop-shadow-lg">
            {title}
          </h1>
